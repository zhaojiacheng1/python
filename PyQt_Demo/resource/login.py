...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout.addWidget(
            self.pushButton, 0, QtCore.Qt.AlignLeft | QtCore.Qt.AlignBottom)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/login/images/login_item_icon1.jpg"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.account_cb.addItem(icon, "")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/login/images/login_item_icon2.jpg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.login_btn.setStyleSheet(
            ...
            "}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/login/images/login_btn_icon.jpg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_2.setStyleSheet(
            "border-image: url(:/login/images/login_qrcode.jpg);")
        ...
        self.account_cb.editTextChanged['QString'].connect(
            Form.enable_login_btn)
