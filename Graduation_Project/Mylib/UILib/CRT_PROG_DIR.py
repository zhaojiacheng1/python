...
# Form implementation generated from reading ui file 'CRT_PROG_DIR.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Lab_File_Name.setIndent(10)
        self.Lab_File_Name.setObjectName("Lab_File_Name")
        self.horizontalLayout_2.addWidget(self.Lab_File_Name)
        ...
        self.Lab_LineNum.setIndent(10)
        self.Lab_LineNum.setObjectName("Lab_LineNum")
        self.horizontalLayout_2.addWidget(self.Lab_LineNum)
        ...
        self.label_3.setStyleSheet("border-top: 2px solid white;\n"
"border-left: 2px solid white;")
        ...
        self.label_4.setStyleSheet("border-top: 2px solid white;\n"
"border-right: 2px solid rgb(140,140,140);")
        ...
        self.Lab_MemoryUsed = QtWidgets.QLabel(self.widget_10)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.Lab_MemoryUsed.setFont(font)
        self.Lab_MemoryUsed.setStyleSheet("border-right: 2px solid rgb(140,140,140);")
        self.Lab_MemoryUsed.setAlignment(QtCore.Qt.AlignCenter)
        self.Lab_MemoryUsed.setObjectName("Lab_MemoryUsed")
        self.gridLayout.addWidget(self.Lab_MemoryUsed, 1, 3, 1, 1)
        self.Lab_MemoryFree = QtWidgets.QLabel(self.widget_10)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.Lab_MemoryFree.setFont(font)
        self.Lab_MemoryFree.setStyleSheet("border-bottom: 2px solid rgb(140,140,140);\n"
"border-right: 2px solid rgb(140,140,140);")
        self.Lab_MemoryFree.setAlignment(QtCore.Qt.AlignCenter)
        self.Lab_MemoryFree.setObjectName("Lab_MemoryFree")
        self.gridLayout.addWidget(self.Lab_MemoryFree, 2, 3, 1, 1)
        self.Lab_ProgramUsedNum = QtWidgets.QLabel(self.widget_10)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.Lab_ProgramUsedNum.setFont(font)
        self.Lab_ProgramUsedNum.setStyleSheet("")
        self.Lab_ProgramUsedNum.setObjectName("Lab_ProgramUsedNum")
        self.gridLayout.addWidget(self.Lab_ProgramUsedNum, 1, 1, 1, 1)
        ...
        self.label_10.setStyleSheet("border-left: 2px solid white;\n"
"border-bottom: 2px solid rgb(140,140,140);")
        self.label_10.setAlignment(QtCore.Qt.AlignCenter)
        self.label_10.setObjectName("label_10")
        self.gridLayout.addWidget(self.label_10, 2, 0, 1, 1)
        self.Lab_ProgramFreeNum = QtWidgets.QLabel(self.widget_10)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.Lab_ProgramFreeNum.setFont(font)
        self.Lab_ProgramFreeNum.setStyleSheet("border-bottom: 2px solid rgb(140,140,140);")
        self.Lab_ProgramFreeNum.setObjectName("Lab_ProgramFreeNum")
        self.gridLayout.addWidget(self.Lab_ProgramFreeNum, 2, 1, 1, 1)
        ...
        self.programdirwindow = QtWidgets.QWidget(Form)
        self.programdirwindow.setStyleSheet("")
        self.programdirwindow.setObjectName("programdirwindow")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.programdirwindow)
        self.horizontalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_7.setSpacing(0)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.verticalLayout.addWidget(self.programdirwindow)
        ...
        self.Lab_ProgramEdit = QtWidgets.QWidget(self.widget_4)
        self.Lab_ProgramEdit.setStyleSheet("")
        self.Lab_ProgramEdit.setObjectName("Lab_ProgramEdit")
        self.horizontalLayout_3.addWidget(self.Lab_ProgramEdit)
        ...
        self.Lab_OSper = QtWidgets.QLabel(self.widget_6)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_4.addWidget(self.Lab_OSper)
        ...
        self.Lab_Lper = QtWidgets.QLabel(self.widget_6)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_4.addWidget(self.Lab_Lper)
...
"border-bottom: 2px solid rgb(140,140,140);")
        ...
        self.Btn_One = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_Two = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_Three = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_Four = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_Five = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_Eight = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_Nine = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_Ten = CRTSoftBtn(self.widget_5)
        ...
        self.Btn_GO = QtWidgets.QPushButton(self.widget_5)
        ...
        self.verticalLayout.setStretch(2, 47)
        self.verticalLayout.setStretch(3, 11)
        self.verticalLayout.setStretch(4, 11)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "PROGRAM(NUM.)"))
        self.label_4.setText(_translate("Form", "MEMORY(CHAR.)"))
        self.label_6.setText(_translate("Form", "USED"))
        self.Lab_MemoryUsed.setText(_translate("Form", "0"))
        self.Lab_MemoryFree.setText(_translate("Form", "0"))
        self.Lab_ProgramUsedNum.setText(_translate("Form", "0"))
        self.label_10.setText(_translate("Form", "FREE"))
        self.Lab_ProgramFreeNum.setText(_translate("Form", "0"))
